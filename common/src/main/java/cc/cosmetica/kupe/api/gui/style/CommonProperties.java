...
public final class CommonProperties {
	...
	/**
	 * The preferred size of the component. This does not include padding or margins.
	 * This overrides the preferred size due to the component's children.
	 */
	public static final Style.Property<DimensionsOperator<Optional<Dimensions>>> PREFERRED_SIZE = new Style.Property<>((vw, vh) -> Optional.empty());
